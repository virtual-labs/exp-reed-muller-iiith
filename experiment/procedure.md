...
<div style="text-align: center;">
    <img src="images/monomial_task1.png" alt="alt text" width="500"/>
</div>

2. **Evaluate the codeword corresponding to the monomial**: Given a monomial, find its evaluation at tuples given below

<div style="text-align: center;">
    <img src="images/monomial_task2.png" alt="alt text" width="500"/>
</div>
...
<div style="text-align: center;">
    <img src="images/polynomial_task1.png" alt="alt text" width="500"/>
</div>

2. **Evaluate the codeword corresponding to the polynomial**: Given a polynomial, find its evaluation at tuples given below

<div style="text-align: center;">
    <img src="images/polynomial_task2.png" alt="alt text" width="500"/>
</div>
